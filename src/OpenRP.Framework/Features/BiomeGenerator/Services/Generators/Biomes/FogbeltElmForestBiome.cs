...
{
    [Biome(100, "Elm Forest", BiomeType.Fogbelt)]
    public class FogbeltElmForestBiome : ElmForestBiome
    {
        ...
        public FogbeltElmForestBiome(IBiomeObjectFactory factory) : base(factory) { }
