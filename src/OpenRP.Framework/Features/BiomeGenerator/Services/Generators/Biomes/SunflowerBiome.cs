...
{
    [Biome(3, "Sunflower Fields", BiomeType.RedCounty)]
    public class SunflowerBiome : IBiome
    {
        ...
        public SunflowerBiome(IBiomeObjectFactory factory)
        {
            _factory = factory;
        ...
        public virtual Color GetBiomeOutputColor() => new Color(255, 255, 0);
    }
}