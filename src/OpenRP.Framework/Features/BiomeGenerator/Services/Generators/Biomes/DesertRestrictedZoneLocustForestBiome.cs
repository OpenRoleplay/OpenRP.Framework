...
{
    [Biome(40, "Desert Locust Forest", BiomeType.DesertRestrictedZone)]
    public class DesertRestrictedZoneLocustForestBiome : IBiome
    {
        ...
        public DesertRestrictedZoneLocustForestBiome(IBiomeObjectFactory factory)
        {
            _factory = factory;
