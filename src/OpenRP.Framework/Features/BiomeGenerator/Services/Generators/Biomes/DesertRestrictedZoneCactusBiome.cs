...
{
    [Biome(75, "Desert Cactus", BiomeType.DesertRestrictedZone)]
    public class DesertRestrictedZoneCactusBiome : IBiome
    {
        ...
        public DesertRestrictedZoneCactusBiome(IBiomeObjectFactory factory)
        {
            _factory = factory;
