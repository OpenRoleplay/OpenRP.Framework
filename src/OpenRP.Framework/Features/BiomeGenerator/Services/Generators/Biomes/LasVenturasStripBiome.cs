...
{
    [Biome(30, "Venturas Strip Palms", BiomeType.LasVenturasStrip)]
    public class LasVenturasStripBiome : IBiome
    {
        ...
        public LasVenturasStripBiome(IBiomeObjectFactory factory)
        {
            _factory = factory;
        ...
        public Color GetBiomeOutputColor() => new Color(164, 164, 0);
    }
}
