...
{
    [Biome(100, "Desert Plains", BiomeType.DesertRestrictedZone)]
    public class DesertRestrictedZonePlainsBiome : IBiome
    {
        ...
        public DesertRestrictedZonePlainsBiome(IBiomeObjectFactory factory) 
        {
            _factory = factory;
